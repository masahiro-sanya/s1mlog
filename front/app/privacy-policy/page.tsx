...
export default function PrivacyPolicyPage() {
  return (
    <div className={styles.container}>
      ...
      <p>
        当サイトは第三者配信の広告サービスであるGoogle
        AdSenseを使用する場合があります。Googleなどの第三者配信事業者は、ユーザーの興味に応じた広告を表示するためにCookieを使用することがあります。パーソナライズド広告に使用されるCookieを無効にする方法等の詳細は、
        <a
      ...
      <p>本ポリシーの内容は、法令の変更や運用状況に応じて、予告なく変更される場合があります。</p>
